...
@RestController
@RequestMapping("/api/finance-admin-kafka")
public class FinanceAdminKafkaResource {

    private final Logger log = LoggerFactory.getLogger(FinanceAdminKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public FinanceAdminKafkaResource(KafkaProperties kafkaProperties) {
