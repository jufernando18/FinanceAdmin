...
import { UserRegistryComponent } from 'app/entities/user-registry/user-registry.component';
...
describe('Component Tests', () => {
  describe('UserRegistry Management Component', () => {
    let comp: UserRegistryComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(UserRegistryComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.userRegistries && comp.userRegistries[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
