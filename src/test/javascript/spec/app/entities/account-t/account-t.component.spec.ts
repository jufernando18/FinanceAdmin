...
import { AccountTComponent } from 'app/entities/account-t/account-t.component';
...
describe('Component Tests', () => {
  describe('AccountT Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.accountTS && comp.accountTS[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
